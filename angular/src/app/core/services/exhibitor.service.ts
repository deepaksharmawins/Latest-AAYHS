...
export class ExhibitorService {
  ...
  //All Exhibitor by sortBy
  getFilterExhibitors(data) {
    return this.http.post<any>(`${this.api}ExhibitorAPI/GetFilterExhibitors`, data);
  }

   //All exhibitor sponsor
   getAllSponsorsOfExhibitors() {
    return this.http.get<any>(`${this.api}ExhibitorAPI/GetAllSponsorsOfExhibitors`)
  }
}
